...
namespace CapaPresentacion
{
    public partial class frmCompras : Form
    {
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Precio de compra incorrecto", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtpreciocompra.Select();
                return;
            }
            ...
            {
                MessageBox.Show("Precio de venta - Formato moneda icnorrecto", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
